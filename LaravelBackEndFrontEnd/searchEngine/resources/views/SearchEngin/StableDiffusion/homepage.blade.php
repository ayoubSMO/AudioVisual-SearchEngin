...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  {!! Form::open(['action' => 'App\Http\Controllers\StableDiffController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
  <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center" data-aos="fade" data-aos-delay="1500">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span>Jaw bot</span> a cute artificial intelligent maded with Stable Diffusion</h2>
          <p>I can read ur mind and drawe everything you want !</p>
          <input name = "search-input" id="search-input" class="search-input" type="text" size="60" >
        </div>
      </div>
    </div>
